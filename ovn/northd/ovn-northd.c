...
struct ovn_port {
    ...
    struct lport_addresses *ps_addrs;   /* Port security addresses. */ //port安全组信息
                    ...
                    struct hmap *lflows, struct hmap *mcgroups)
{
    ...
    HMAP_FOR_EACH (od, key_node, datapaths) {
        ...
        build_pre_acls(od, lflows);//acl的整体架子，优先保证需要的通（使规则不能影响）
